...
GIT_SSH_COMMAND="ssh -i /data/id_rsa_github -o StrictHostKeyChecking=no" git clone --single-branch --branch ${branch} --depth=1 git@github.com:opgm/openpilot.git /data/openpilot_build
